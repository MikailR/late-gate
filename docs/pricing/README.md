...
| [pricing-paper.html](./pricing-paper.html) | **Print/academic HTML** (Times / letter — preferred view) |
| [pricing-paper.pdf](./pricing-paper.pdf) | PDF of the academic paper |
...
Prefer the print/academic HTML or PDF — not a product website layout. Academic paper look is locked.
