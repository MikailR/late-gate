...
Internal Eng / Rails docs for parametric Takeoff & Arrival delay stubs.

| Doc | Purpose |
|---|---|
| [technical-paper-flight-delay-pricing.md](./technical-paper-flight-delay-pricing.md) | Full technical paper (source) |
| [exec-summary.md](./exec-summary.md) | 1-pager for Mikail |
| [pricing-paper.html](./pricing-paper.html) | Academic / print HTML |
| [pricing-paper-academic.html](./pricing-paper-academic.html) | Same academic HTML (alias) |
...
Prefer print/academic HTML or PDF; not a product website. PNG figures and large BTS zip microdata live with the Financial Research box pack.
